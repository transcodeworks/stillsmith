...
The authoring GUI ships as its own package, `@stillsmith/studio` — capture
stays a lean dev dependency, and the studio comes along only where a human
authors visually.
